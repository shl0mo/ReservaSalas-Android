...
public class SelecionarUsuarioAlteradoActivity extends AppCompatActivity {
    ...
    public void selecionarId (View v) {
        ...
        Intent in = new Intent(SelecionarUsuarioAlteradoActivity.this, AlterarUsuarioActivity.class);
        in.putExtra("Id", id);
        startActivity(in);
    }
